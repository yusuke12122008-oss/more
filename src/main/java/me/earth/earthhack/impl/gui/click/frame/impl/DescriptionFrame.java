...
public class DescriptionFrame extends Frame
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Render2DUtil.drawRect(getPosX(), getPosY(), getPosX() + getWidth(), getPosY() + getHeight(), Click.CLICK_GUI.get().headerColor.getValue().getRGB());
        Render2DUtil.drawBorderedRect(getPosX(), getPosY(), getPosX() + getWidth(), getPosY() + getHeight(), 0.5f, 0, Click.CLICK_GUI.get().outlineColor.getValue().getRGB());
        Managers.TEXT.drawStringWithShadow(getLabel(), getPosX() + 3, getPosY() + getHeight() / 2 - (Managers.TEXT.getStringHeightI() >> 1), Click.CLICK_GUI.get().enabledTextColor.getValue().getRGB());
        ...
        Render2DUtil.drawRect(getPosX(), getPosY() + getHeight(), getPosX() + getWidth(), getPosY() + getHeight() + 3 + (Managers.TEXT.getStringHeightI() + 1) * strings.size(), Click.CLICK_GUI.get().backgroundColor.getValue().getRGB());

        for (String string : strings)
        {
            Managers.TEXT.drawStringWithShadow(string, this.getPosX() + 3, y, Click.CLICK_GUI.get().enabledTextColor.getValue().getRGB());
