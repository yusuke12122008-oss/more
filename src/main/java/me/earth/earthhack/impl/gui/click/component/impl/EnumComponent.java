...
public class EnumComponent<E extends Enum<E>> extends SettingComponent<E, EnumSetting<E>> {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Managers.TEXT.drawStringWithShadow(getLabel() + ": " +ChatFormatting.GRAY + getEnumSetting().getValue().name(), getFinishedX() + 5, getFinishedY() + getHeight() / 2 - (Managers.TEXT.getStringHeightI() >> 1), getClickGui().get().enabledTextColor.getValue().getRGB());
    }
